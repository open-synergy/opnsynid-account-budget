...
class BudgetDirectCashPeriodHelperHeader(models.Model):
    _name = "budget.direct_cash_period_helper_header"
    _description = "Direct Cash Budget Report Per Period - Header Helper"
    _auto = False
