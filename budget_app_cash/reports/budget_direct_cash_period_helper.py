...
class BudgetDirectCashPeriodHelper(models.Model):
    _name = "budget.direct_cash_period_helper"
    _description = "Direct Cash Budget Report Helper Per Period"
    _auto = False
    ...
    def _select(self):
        ...
        SELECT
            ...
            a.direct_cash_flow_code_id AS cash_flow_code_id,
    ...
    def _group_by(self):
        group_str = """
            GROUP BY a.direct_cash_flow_code_id,
            a.company_id,
            a.version_id,
            a.period_id
        """
